# Bem vindo jogo Banco Imobiliario DF
...
Para que essa API possa ser executada é necessário instalar algumas extensões que ja estão incluidas no arquivo requirements.txt:
...
- Digitar no terminal do editor de texto o comando **python test.py**
- Neste momento será executado os 300 testes no jogo e devolverá os resultados solicitados
